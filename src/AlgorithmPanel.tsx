...
export default function AlgorithmPanel({simplified,presentationStage,route,flow,weather,at,frozen,onWeather,onTraffic,onClose}:{simplified?:boolean;presentationStage?:number;route:Route|null;flow:FlowResult;weather:Weather;at:Date;frozen:boolean;onWeather:(snow:boolean)=>void;onTraffic:(busy:boolean)=>void;onClose:()=>void}) {
